  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-8 space-y-6">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-amber-900 dark:text-amber-200 mb-2">Recipe Flow</h1>
        <p className="text-amber-700 dark:text-amber-400">
          Transform recipes into interactive cooking flowcharts
        </p>
      </div>
      ...
      {/* Quick Tips */}
      <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-4 border border-amber-200/50 dark:border-gray-700/50">
